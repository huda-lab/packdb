...
MetricsType MetricsUtils::GetOptimizerMetricByType(OptimizerType type) {
    switch(type) {
        ...
        case OptimizerType::DECIDE_OPTIMIZER:
            return MetricsType::OPTIMIZER_DECIDE;
       default:
...
OptimizerType MetricsUtils::GetOptimizerTypeByMetric(MetricsType type) {
    switch(type) {
        ...
        case MetricsType::OPTIMIZER_DECIDE:
            return OptimizerType::DECIDE_OPTIMIZER;
    default:
